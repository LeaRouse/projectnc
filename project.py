...
.icon-button {
  ...
  overflow:hidden; cursor:pointer; transition: transform .2s ease; z-index:5;
}
.icon-button:hover { transform: scale(1.05); }

.icon-button img { width:100%; height:100%; object-fit:cover; border-radius:inherit; pointer-events:none; }
...
# Botones HTML/JS (solo imagen, sin texto)
